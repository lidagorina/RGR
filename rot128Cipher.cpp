...
static void rot128TransformByte(uint8_t* byte) {
    *byte = (*byte + 128) % 256;
}
...
EXPORT const char* getAlgorithmName() {
    return "ROT128 (шифр со сдвигом 128)";
}

EXPORT const char* getKeyInfo() {
    return "Шифр замены на основе сдвига байтов на 128 позиций.\n"
